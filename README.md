...
A unique feature of this website is its interactive animated gradient background, which is rendered directly on the GPU using custom vertex/fragment shaders with Three.js and React Three Fiber for a smooth and performant visual experience.
The effect is based on a shader provided here:
...
* [Bun](https://bun.sh/) - An incredibly fast JavaScript runtime, bundler, and package manager.
...
* **Bun** (v1.x or higher). You can install it from [bun.sh](https://bun.sh/).
...
5.  **(Optional) Set up environment variables:**
    If required, create a `.env` file in the root of the project and add the necessary variables.
    ```
    # Example
...
**Talente Spenden** - [www.talente-spenden.com](https://www.talente-spenden.com/)
