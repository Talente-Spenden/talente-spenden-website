                    ...
                    <h1
                      className={`text-purple italic font-bold ${
                        expandedElement != 1 && expandedElement != 0
                          ? "text-xl sm:text-4xl"
                          : "text-xl md:text-3xl lg:text-4xl 2xl:text-6xl"
                      } group-hover:text-purple-mid-light transition-all`}
                    >
                      Start a New Project
                    </h1>
                    {expandedElement != 1 ? (
                      <p className="text-grey-dark w-full md:w-[85%] 2xl:w-[60%] lg:text-xl mt-2 md:mt-10 group-hover:text-grey-light transition-all">
              ...
              >
                <div className="flex flex-col justify-between h-full">
                  <div>
                    ...
                    <p className="text-grey-dark lg:text-xl w-full md:w-[85%] 2xl:w-[60%] mt-2 md:mt-10 group-hover:text-grey-light transition-all">
          ...
          <div
            className={` ${
              expandedElement == 3
                ...
                : "w-full 2xl:w-[66%] bg-white hover:bg-black"
          ...
          >
            <div className="flex flex-col justify-between h-full">
              <div className="h-full">
                ...
                {expandedElement != 3 ? (
                  <p className="text-grey-dark mt-2 md:mt-10 group-hover:text-grey-light lg:text-xl transition-all">
                    The Talente Spenden Core is the heart of Talente Spenden -
                    and your chance for regularly committment in one of the
                    following area: Technology, Events, Communication and Social
                  ...
                  <div className="">
                    <div>
                      ...
                      <p className="text-white mb-4 w-full 2xl:w-[90%]">
                        ...
                        provides you with the possibitlity to have a great
                        impact on Talente Spenden. Currently, for each of the
                        following areas there is one team respectively -
                        Communication, Technology, Event and Entrepreneurship.
                        There's also the Management Team consisting of the Team
                        Leads of the former four teams.
                      </p>
                      <h2 className="mt-4 text-purple-mid-light font-bold text-2xl ">
                        &rarr; What are the Core Teams Doing?
                      </h2>
                      <div className="w-full my-2 h-[2px] bg-grey-light" />{" "}
                      <div className="flex gap-x-2 justify-between  w-full 2xl:w-[90%]">
                        <p className="text-white font-semibold">Technology</p>
                        <p className="text-white w-[85%] 2xl:w-[80%]">
                          Our Technology Team develops software that creates
                          social value. It's main purpose is to create and
                          manage tools to push Talente Spenden's impact -
                          however also project that directy contribute to social
                          value might be realised.
                        </p>
                      </div>
                      <div className="mt-2 gap-x-2 flex justify-between w-full 2xl:w-[90%]">
                        <p className="text-white font-semibold">Event</p>{" "}
                        <p className="text-white  w-[85%] 2xl:w-[80%]">
                          The Event Team organizes and innovates Talente
                          Spenden's event, including our regular events such as
                          our Summer Fest, Semester Kick-Off. The Team also
                          explores and develops brand-new event concepts for
                          Talente Spenden.
                        </p>
                      </div>
                      <div className="mt-2 gap-x-2 flex justify-between w-full 2xl:w-[90%]">
                        ...
                        <p className="text-white w-[85%] 2xl:w-[80%]">
                          The Event Team organizes and innovates Talente
                          Spenden's event, including regular events such as our
                          Summer Fest or Kick-Offs. The Team also explores and
                      ...
                      <div className="mt-2 gap-x-2 flex justify-between w-full 2xl:w-[90%]">
                        ...
                        <p className="text-white w-[85%] 2xl:w-[80%]">
                          ...
                          can be created in an economically attractive way. It
                          is responsible for our newest Track - the TSET, where
                          supporting innovative Social Entrepreneurship is the
                          goal.
                        </p>
                      </div>
                    </div>
                    <div className="flex mt-2 gap-6 w-full">
                      <div className="w-[50%]">
                        <h2 className="mt-4 text-purple-mid-light font-bold text-2xl ">
                          &rarr; How to apply
                        </h2>
                        ...
                        <p className="text-white">
                          ...
                          why its a good fit for you and we’ll take it from
                          there. Also, a brief introduction about yourself would
                          be amazing!
                          <br />
                          <br />
