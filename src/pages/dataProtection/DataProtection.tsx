export const DataProtection: React.FC = () => {
  return (
    <div className="bg-black">
      <div className="min-h-screen px-6 pt-[20vh] text-white pb-12 lg:max-w-[80vw]">
        <h1 className="font-bold text-3xl">Datenschutz&shy;erkl&auml;rung</h1>
        ...
        <p>
          ...
          <br />
          Google Ireland Limited Gordon House, <br />
        ...
        <p>
          ...
          <br />
          Hochschulreferat Fundraising (HR5)
          <br />
...
noreferrer"
        ...
        <h3>Google Drive</h3>{" "}
        <p>
          Wir haben Google Drive auf dieser Website eingebunden. Anbieter ist
        ...
        <p>
          ...
          Website einzubinden, in dem Sie Inhalte hochladen k&ouml;nnen. Wenn
          Sie Inhalte hochladen, werden diese auf den Servern von Google Drive
          gespeichert. Wenn Sie unsere Website betreten, wird au&szlig;erdem
          eine Verbindung zu Google Drive aufgebaut, sodass Google Drive
          feststellen kann, dass Sie unsere Website besucht haben.
        </p>{" "}
        <p>
          Die Verwendung von Google Drive erfolgt auf Grundlage von Art. 6 Abs.
...
noreferrer"
        ...
        <h2>Verarbeitung von Bewerberdaten bei E-Mail-Bewerbungen</h2>
        <p>
          Wir bieten Ihnen die M&ouml;glichkeit, sich per E-Mail bei uns zu
          bewerben. Im Folgenden informieren wir Sie &uuml;ber die Verarbeitung
          Ihrer personenbezogenen Daten im Rahmen des Bewerbungsverfahrens
          gem&auml;&szlig; der Datenschutz-Grundverordnung (DSGVO) und dem
          Bundesdatenschutzgesetz (BDSG).
        </p>
        <h3>1. Verantwortliche Stelle f&uuml;r die Datenverarbeitung</h3>
        <p>
          Verantwortlicher f&uuml;r die Verarbeitung Ihrer Bewerbungsdaten ist:
          <br />
          Talente Spenden e.V.
          <br />
          Talente Spenden e.V. Technische Universität München Hochschulreferat
          Fundraising (HR5) Arcisstraße 21 80333 München Deutschland
          <br />
        ...
        <p>
          Wir verarbeiten die personenbezogenen Daten, die Sie uns im Rahmen
          Ihrer Bewerbung per E-Mail zur Verf&uuml;gung stellen,
          ausschlie&szlig;lich zum Zwecke der Durchf&uuml;hrung des
          Bewerbungsverfahrens und zur Entscheidung &uuml;ber die
          Begr&uuml;ndung eines Besch&auml;ftigungsverh&auml;ltnisses.
        </p>
        <p>
          Die prim&auml;re Rechtsgrundlage f&uuml;r die Verarbeitung Ihrer
          personenbezogenen Daten in diesem Bewerbungsverfahren ist &sect; 26
          Abs. 1 BDSG (Datenverarbeitung f&uuml;r Zwecke des
          Besch&auml;ftigungsverh&auml;ltnisses) in Verbindung mit Art. 88
          DSGVO. Sofern die Verarbeitung Ihrer Daten zur Erf&uuml;llung
          rechtlicher Verpflichtungen erforderlich ist, dient zudem Art. 6 Abs.
          1 lit. c DSGVO als Rechtsgrundlage. Sollten die Daten nach Abschluss
          des Bewerbungsverfahrens ggf. zur Rechtsverfolgung erforderlich sein,
          kann eine Datenverarbeitung auf Basis der Voraussetzungen von Art. 6
          Abs. 1 lit. f DSGVO (Wahrung berechtigter Interessen) erfolgen. Unser
          berechtigtes Interesse besteht dann beispielsweise in der
          Geltendmachung oder Abwehr von Anspr&uuml;chen (z.B. nach dem
          Allgemeinen Gleichbehandlungsgesetz - AGG).
        </p>
        <h3>3. Kategorien personenbezogener Daten</h3>
        <p>
          Zu den verarbeiteten Kategorien personenbezogener Daten geh&ouml;ren
          insbesondere:
        </p>
        <ul>
          <li>
            Ihre Stammdaten (Vorname, Nachname, Titel, Anschrift, Geburtsdatum
            etc.)
          </li>
          <li>Kontaktdaten (E-Mail-Adresse, Telefonnummer)</li>
          <li>
            Qualifikationsdaten (Anschreiben, Lebenslauf, Zeugnisse,
            Zertifikate, Angaben zu bisherigen T&auml;tigkeiten, Weiterbildungen
            etc.)
          </li>
          <li>
            Gegebenenfalls weitere von Ihnen im Rahmen der Bewerbung freiwillig
            gemachte Angaben (z.B. Foto, Angaben zu Gehaltsvorstellungen,
            fr&uuml;hestm&ouml;glicher Eintrittstermin).
          </li>
        </ul>
        <p>
          Bitte teilen Sie uns im Rahmen Ihrer Bewerbung grunds&auml;tzlich
          keine besonderen Kategorien personenbezogener Daten im Sinne des Art.
          9 Abs. 1 DSGVO mit (z.B. Gesundheitsdaten, Angaben zur ethnischen
          Herkunft, politischen Meinungen, religi&ouml;sen oder
          weltanschaulichen &Uuml;berzeugungen,
          Gewerkschaftszugeh&ouml;rigkeit), es sei denn, diese sind f&uuml;r die
          konkrete Stellenausschreibung ausnahmsweise relevant.
        </p>
        <h3>4. Empf&auml;nger der Daten</h3>
        <p>
          Innerhalb unseres Unternehmens erhalten nur die Personen und Stellen
          Zugriff auf Ihre Bewerbungsdaten, die unmittelbar in den
          Personalauswahlprozess eingebunden sind. Dies sind in der Regel
          Mitarbeiter der Personalabteilung sowie die F&uuml;hrungskr&auml;fte
          und Mitarbeiter der Fachabteilung, die die zu besetzende Stelle
          ausgeschrieben hat.
        </p>
        <p>
          Eine Weitergabe Ihrer Daten an Dritte au&szlig;erhalb unseres
          Unternehmens erfolgt grunds&auml;tzlich nicht, es sei denn, Sie haben
          hierzu ausdr&uuml;cklich eingewilligt oder wir sind aufgrund
          gesetzlicher Bestimmungen oder beh&ouml;rdlicher oder gerichtlicher
          Anordnungen hierzu verpflichtet.
        </p>
        <h3>5. Dauer der Datenspeicherung</h3>
        <p>
          Wir speichern Ihre personenbezogenen Bewerbungsdaten f&uuml;r die
          Dauer des Bewerbungsverfahrens.
        </p>
        <p>
          Wird Ihre Bewerbung abgelehnt, l&ouml;schen wir Ihre Daten in der
          Regel sp&auml;testens sechs Monate nach Bekanntgabe der
          Absageentscheidung. Diese Speicherdauer ergibt sich aus der
          Notwendigkeit, uns gegebenenfalls gegen Anspr&uuml;che aus dem
          Allgemeinen Gleichbehandlungsgesetz (AGG) verteidigen zu k&ouml;nnen.
        </p>
        <p>
          Sofern Sie uns Ihre ausdr&uuml;ckliche Einwilligung erteilt haben,
          Ihre Daten f&uuml;r die Ber&uuml;cksichtigung bei zuk&uuml;nftigen
          Stellenausschreibungen l&auml;nger zu speichern (Aufnahme in einen
          Bewerberpool), erfolgt die Speicherung entsprechend Ihrer
          Einwilligung.
        </p>
        <p>
          Kommt es im Anschluss an das Bewerbungsverfahren zu einem
          Besch&auml;ftigungsverh&auml;ltnis mit Ihnen, werden Ihre
          Bewerbungsunterlagen in Ihre Personalakte &uuml;berf&uuml;hrt und
          gem&auml;&szlig; den f&uuml;r Personalakten geltenden gesetzlichen und
          betrieblichen Aufbewahrungsfristen verarbeitet und gespeichert.
        </p>
        <h3>6. Ihre Rechte als betroffene Person</h3>
        <p>
          Als Bewerberin oder Bewerber haben Sie bez&uuml;glich Ihrer
        ...
        <ul>
          ...
          <li>
            Recht auf L&ouml;schung („Recht auf Vergessenwerden“) (Art. 17
            DSGVO)
          </li>
          <li>Recht auf Einschr&auml;nkung der Verarbeitung (Art. 18 DSGVO)</li>
          <li>
            Recht auf Widerspruch gegen die Verarbeitung (Art. 21 DSGVO), sofern
          ...
          <li>
            ...
            DSGVO) mit Wirkung f&uuml;r die Zukunft, ohne dass die
            Rechtm&auml;&szlig;igkeit der aufgrund der Einwilligung bis zum
            Widerruf erfolgten Verarbeitung ber&uuml;hrt wird.
          </li>
        </ul>
        <p>
          Zur Aus&uuml;bung Ihrer Rechte wenden Sie sich bitte an die oben
          genannte verantwortliche Stelle oder unseren Datenschutzbeauftragten.
        </p>
        <p>
          Zus&auml;tzlich haben Sie das Recht, sich bei einer
          Datenschutz-Aufsichtsbeh&ouml;rde &uuml;ber die Verarbeitung Ihrer
          personenbezogenen Daten durch uns zu beschweren (Art. 77 DSGVO). Die
          f&uuml;r uns zust&auml;ndige Aufsichtsbeh&ouml;rde ist in der Regel
          das Bayerische Landesamt f&uuml;r Datenschutzaufsicht (BayLDA) oder
          die Aufsichtsbeh&ouml;rde an Ihrem &uuml;blichen Aufenthaltsort oder
          Arbeitsplatz.
        </p>
        <h3>7. Sicherheitshinweis f&uuml;r Bewerbungen per E-Mail</h3>
        <p>
          Wir weisen darauf hin, dass die Daten&uuml;bertragung bei der
          Kommunikation per E-Mail Sicherheitsl&uuml;cken aufweisen kann. Ein
          l&uuml;ckenloser Schutz der &uuml;bermittelten Daten vor dem Zugriff
          durch unbefugte Dritte ist bei einer unverschl&uuml;sselten
          E-Mail-Kommunikation nicht vollst&auml;ndig gew&auml;hrleistet. Sofern
          Sie uns sensible Daten &uuml;bermitteln m&ouml;chten, empfehlen wir
          Ihnen, alternative, sicherere &Uuml;bertragungswege in Betracht zu
          ziehen, sofern von uns angeboten, oder geeignete
          Verschl&uuml;sselungsma&szlig;nahmen f&uuml;r Ihre E-Mail-Anh&auml;nge
          zu verwenden und uns das Passwort auf einem separaten Weg mitzuteilen.
        </p>
      </div>{" "}
